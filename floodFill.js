...
Room.prototype.floodFillToRamparts = function (seeds,room_plan,if_visualize) {
    ...
    while (thisGeneration.length) {
        ...
        for (const pos of thisGeneration) {
            ...
            if (depth != 0) {
                ...
                if (terrain.get(pos.x, pos.y) == TERRAIN_MASK_WALL || room_plan[pos.x][pos.y]==STRUCTURE_RAMPART) continue
