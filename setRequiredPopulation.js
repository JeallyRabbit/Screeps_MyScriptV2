function setRequiredPopulation(mySpawns) {
    ...
    mySpawns['Spawn1'].memory.req_DistanceCarriers=mySpawns['Spawn1'].memory.farming_rooms.length*1;//role num 14
    ...
    if( mySpawns['Spawn1'].memory.farmers_counter>500 ||  mySpawns['Spawn1'].memory.farmers_counter==undefined)
    {
        mySpawns['Spawn1'].memory.farmers_counter=0;
    }
    if(mySpawns['Spawn1'].memory.reservers_counter>500 || mySpawns['Spawn1'].memory.reservers_counter==undefined)
    {
        mySpawns['Spawn1'].memory.reservers_counter=0;
    }
    if(mySpawns['Spawn1'].memory.distance_carriers_counter>500 || mySpawns['Spawn1'].memory.distance_carriers_counter==undefined)
    {
        mySpawns['Spawn1'].memory.distance_carriers_counter=0;
    }
    if(mySpawns['Spawn1'].memory.soldiers_counter>500 || mySpawns['Spawn1'].memory.soldiers_counter==undefined)
    {
        mySpawns['Spawn1'].memory.soldiers_counter=0;
    }
